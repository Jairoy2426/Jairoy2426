...
I'm **Hercules**, a cybersecurity-focused software developer with strong hands-on experience in **server hosting, Cloudflare, and backend development**.

- 🔐 Passionate about **cybersecurity & server hardening**
- ☁ Experienced with **Cloudflare, DNS, reverse proxy & hosting**
- 🧑‍💻 Backend-focused developer (Python, TypeScript, APIs)
- 🛡 Interested in firewalls, traffic monitoring & infrastructure security
- 🧪 Love building practical security tools and utilities
